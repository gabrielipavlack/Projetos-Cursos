...
<?php include(TEMPLATEPATH . "/inc/introducao.php"); ?>
		...
		<section class="contato container animar-interno">
			...
			<div class="contato_dados grid-8">
				...
				<span><?php the_field('cidade_e_estado'); ?></span>
		...
		<section class="container contato_mapa">
			<a href="<?php the_field('link_google_maps'); ?>" target="_blank" class="grid-16"><img src="<?php the_field('foto_mapa'); ?>" alt="<?php the_field('endereco_mapa'); ?>"></a>
		</section>
